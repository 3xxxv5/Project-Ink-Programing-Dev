...
public class HighlightableObject : MonoBehaviour
{
    ...
    private bool flashingOnce = false;
	...
	public void FlashOnce(Color color1)
    {
        flashingColorMin = new Color(color1.r, color1.g, color1.b, 1f);
        flashingColorMax = new Color(color1.r,color1.g,color1.b,0f);
        flashingOnce = true;
    }
	/// <summary>
	...
	private void UpdateColors()
	{
        ...
        if (flashingOnce)
        {
            ...
            Color c = Color.Lerp(flashingColorMin, flashingColorMax, Time.deltaTime);
            SetColor(c);
            return;
        }
        if (flashing)
